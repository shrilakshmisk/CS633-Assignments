...
// Please view code_documentation.pdf for more detailed information
...
int main(int argc, char *argv[]) 
{
    ...
    double *left_recv = NULL, *right_recv = NULL, *up_recv = NULL, *down_recv = NULL, *left_send = NULL, *right_send = NULL, *up_send = NULL, *down_send = NULL, *int_left_recv = NULL, *int_right_recv = NULL, *int_up_recv = NULL, *int_down_recv = NULL;
	...
	if(argc == 6){
        ...
        printf("Please provide 6 arguments\n");
        return 0;
    }
    ...
    // if(myrank == 0 || myrank == 6)printf("rank %d running on %s\n", myrank, hostname);
